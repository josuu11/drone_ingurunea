...
class ParrotDroneTask(parrotdrone_env.ParrotDroneEnv):
    def __init__(self):
        """
        ...
        LoadYamlFileParamsTest(rospackage_name="openai_ros",
                               rel_path_from_package_to_file="src/openai_ros/task_envs/josutask/config",
        ...
        super(ParrotDroneTask, self).__init__(ros_ws_abspath)
