...
class DroneXY(parrotdrone_env.ParrotDroneEnv):
    def __init__(self):
        """
        ...
        LoadYamlFileParamsTest(rospackage_name="openai_ros",
                               rel_path_from_package_to_file="src/openai_ros/task_envs/drone_xy/config",
        ...
        super(DroneXY, self).__init__(ros_ws_abspath)
